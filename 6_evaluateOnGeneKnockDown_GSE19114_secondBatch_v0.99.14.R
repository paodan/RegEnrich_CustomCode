...
write.table(dataGSE19114TXT, file = "../rawData/dataGSE19114_2.txt", 
            sep = "\t", quote = FALSE, row.names = FALSE)

# viper method on data

netFile = "../rawData/ARACNe_network_GSE19114_2.txt"
if (!file.exists(netFile)){
  expr = "../rawData/dataGSE19114_2.txt"
  tfs = "../rData/tfs.txt"
  outputFolder = "../rData/GSE19114_ARACNe_2/"
...
mrsFile = "../rData/mrs_GSE19114_ARACNe_2_STAT3.Rdata"
...
mrsFile = "../rData/mrs_GSE19114_ARACNe_2_CEBPB.Rdata"
if (file.exists(mrsFile)){
  load(mrsFile)
  cat("loading mrsFile.\n")
} else {
...
mrsFile = "../rData/mrs_GSE19114_ARACNe_2_STAT3_CEBPB.Rdata"
if (file.exists(mrsFile)){
  load(mrsFile)
  cat("loading mrsFile.\n")
} else {
...
phenoGSE19114$group = factor(phenoGSE19114$group,
                             levels = c("NT", "STAT3", "CEBPB", "STAT3_CEBPB")) # second batch
design = model.matrix(~0 + group, data = phenoGSE19114)

contrast = list(STAT3 = c(-1, 1, 0, 0), # NT vs STAT3
...
for(gene in c("STAT3", "CEBPB", "STAT3_CEBPB")){
  ...
  write.table(score, paste0("../rData/score_06_", geoAcession, "_secondBatch_cell_", cell, "_", gene, "_FET.tsv"), sep = "\t")
  save(object, file = paste0("../rData/object_06_", geoAcession, "_secondBatch_cell_", cell, "_", gene, "_FET.Rdata"))
  ...
  score = results_score(object)
  write.table(score, paste0("../rData/score_06_", geoAcession, "_secondBatch_cell_", cell, "_", gene, "_GSEA.tsv"), sep = "\t")
  save(object, file = paste0("../rData/object_06_", geoAcession, "_secondBatch_cell_", cell, "_", gene, "_GSEA.Rdata"))
}


if(FALSE){
  rQsub("./", "6_evaluateOnGeneKnockDown_GSE19114_secondBatch_v0.99.14.R", 
        jobName = "Job_06_GSE19114_secondBatch", threaded = 2, memoryG = "70", 
        rTimeHour = 20, logFile = "logFile_06_GSE19114_secondBatch.log", 
